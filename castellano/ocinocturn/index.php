...
<body> 
	<div data-role="page">
		<img width="100%" align="center" src="../../images/fotos/headerocinocturn.jpg">
		<div data-role="header">
		   ...
		   <?php
				...
				$sentencia = "select guia.poi.id, guia.poi.nom from guia.poi where guia.poi.type='16' order by guia.poi.nom";
		   ...
		   ?>
				...
				<div class="choice_list"> 
					...
					<?php 
						...
						{	
							$web="http://guia.viladecans.cat/castellano/ocinocturn/ocinocturn.php?idNocturn=" .$row['id'];
					?>
