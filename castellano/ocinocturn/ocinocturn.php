...
<head>
	...
	<title>Establecimiento ocio nocturno</title>
	...
	<div data-role="page">
		...
		<div data-role="content">				
				<?php
					...
					$sentencia = $sentencia . "where action1.label='Web' and action2.label='email' and action3.label='telefon' and guia.poi.id=" .$nocturn;
					...
					$rowNocturn = mysql_fetch_assoc($qry);
				
					
				
				?>
				
				<h3><?php echo $rowNocturn['nom']; ?></h3>
				<p align="center"><img width="100%" src="<?php echo $rowNocturn['imageWebURL']; ?>" /></p>
				<p align="justify"><?php echo $rowNocturn['DescripcioCAST']; ?></p>					
				
				<div>	
					<p>Estamos en <?php echo $rowNocturn['adreca']; ?></p>
						
				</div>
				<div data-role="footer" data-position="fixed">
				<div data-role="navbar">
	            	<ul>
						<li><a href="<?php echo $rowNocturn['web']; ?>" class='ui-btn-active' data-icon="home">Web</a></li>
						<li><a href="<?php echo $rowNocturn['telefon']; ?>"  data-icon="phone">Telf</a></li>
						<li><a href="<?php echo $rowNocturn['email']; ?>"  data-icon="mail">Mail</a></li>
						<li><a href="../../mapa.php?lat=<?php echo $rowNocturn['lat']; ?>&long=<?php echo $rowNocturn['lon']; ?> " data-icon="location" data-ajax="false" />Donde</a></li>
					</ul>
	       		 </div>
				</div>
		</div> <!-- Fi content	-->
