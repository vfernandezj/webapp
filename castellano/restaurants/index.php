...
<head>
	...
	<title>Restaurantes Viladecans</title>
	...
	<div data-role="page">
		...
		<div data-role="header">
		   ...
		   <?php
				...
				$sentencia = "select guia.poi.id, guia.poi.nom from guia.poi where guia.poi.type='20' order by guia.poi.nom";
		   ...
		   ?>
				...
				<div class="choice_list"> 
					...
					<?php 
						...
						{	
							$web="http://guia.viladecans.cat/castellano/restaurants/restaurant.php?idRestaurant=" .$row['id'];
					?>
