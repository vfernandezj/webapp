...
<html> 
	...
	<body> 
		...
		<div data-role="content">
			<p align="justify">Por favor, seleccione su destino, la fecha y el horario desde la estación de Viladecans.</p>
		
		<div>
			<form action="./trenform.php" data-ajax="false">
				
				<label for="destino" class="select"><b>Estació de destno:</b></label> 
				...
				<label for="Entre" class="select"><p align="center"><b>Seleccione Hora salida:</b></p></label>
