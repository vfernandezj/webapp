...
<head>
	...
	<title>Farmacias Viladecans</title>
...
<body> 
	<div data-role="page">
		...
		<div data-role="content">
			<div><img src="../../images/farmaciaguardia_es.png" width="100%" / ></div>
				...
				?>
					...
					<div data-role="navbar">
						<ul>
							<li><a href="<?php echo $rowGuardia['uri']; ?>"  data-icon="phone">Llamar</a></li>
							<li><a href="<?php echo $rowGuardia['mapaGoogle']; ?>" data-icon="location">Ubicación</a></li> 	
						</ul>
					</div>	
					<?php
						}
			...
			<div data-role="collapsible" data-theme="c" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
				<h4>Listado Farmacias</h4>
				<ul data-role="listview" data-inset="true" data-filter="true">
					<?php 
						while($row = mysql_fetch_array($qry))
							{	
								$web="http://vilasig.viladecans.cat/guia/castellano/farmacies/farmacia.php?idFarmacia=" .$row['id'];
					?>
					...
					<div data-role="collapsible" data-theme="c" data-content-theme="d" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d">
						...
						<div data-role="navbar">
							<ul>
								<li><a href="<?php echo $row['uri']; ?>" data-icon="phone">Llamar</a></li>
								<li><a href="<?php echo $row['mapaGoogle']; ?>" data-icon="location">Ubicación</a> </li>
							</ul>
						</div>
