...
<head>
	...
	<title>Hoteles Viladecans</title>
...
<body> 
	<div data-role="page">
		<img width="100%" align="center" src="../../images/fotos/cabecerahotel.png">
		<div data-role="header">
		   ...
		   <?php
				...
				$sentencia = "select guia.poi.id, guia.poi.nom from guia.poi where guia.poi.tipus='n'";
		   ...
		   ?>
				...
				<div class="choice_list"> 
					...
					<?php 
						...
						{	
							$web="http://guia.viladecans.cat/castellano/hotels/hotel.php?idHotel=" .$row['id'];
					?>
