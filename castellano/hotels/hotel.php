	...
	<div data-role="page">
		...
		<div data-role="content">				
				<?php
					...
					$sentencia = $sentencia . "where action1.label='Web' and action2.label='email' and action3.label='telefon' and guia.poi.id=" .$hotel;
				...
				<p align="justify"><?php echo $rowHotel['DescripcioCAST']; ?></p>					
				
				<div>	
					<p>Estamos en <?php echo $rowHotel['adreca']; ?></p>
						
				</div>
				<div data-role="navbar">
	            	<ul>
						<li><a href="http://www.ibis.com/es/hotel-5006-ibis-barcelona-aeropuerto-viladecans/index.shtml" class='ui-btn-active' data-icon="home">Web</a></li>
						<li><a href="tel:936584834"  data-icon="phone">Telf</a></li>
						<li><a href="mailto:h5006@accor.com"  data-icon="mail">Mail</a></li>
						<li><a href="../../mapa.php?lat=<?php echo $rowHotel['lat']; ?>&long=<?php echo $rowHotel['lon']; ?> " data-icon="location" data-ajax="false" />Donde</a></li>
					</ul>
	       		 </div>
