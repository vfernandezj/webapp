	...
	<div data-role="page">
		...
		<div data-role="header">
			...
			<div data-role="content">
				...
				<p align="justify"><?php echo $rowPatrimoni['DescripcioCAST']; ?></p>					
				...
				<div data-role="navbar">
	            	<ul>
						...
						<li><a href="../../mapa.php?lat=<?php echo $rowPatrimoni['lat']; ?>&long=<?php echo $rowPatrimoni['lon']; ?> " data-icon="location" data-ajax="false" />Donde</a></li>					
					</ul>
	       		 </div>
