	...
	<div data-role="page">
		...
		<div data-role="header">
			...
			<?php
				...
				$sentencia = "select guia.poi.id, guia.poi.nom from guia.poi where guia.poi.tipus='o'";
			...
			?>
				<div class="choice_list"> 
					...
					<?php 
						...
						{	
							$web="http://guia.viladecans.cat/castellano/llocsinteres/negocis.php?idNegocis=" .$row['id'];
					?>
