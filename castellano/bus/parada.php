...
<div data-role="page">
		...
		<div data-role="header">
			...
			<div data-role="content">
				...
				<h3 style="color:#007755" align="justify"><b>Nº parada&nbsp;<?php echo $rowParada['nom']; ?></b></h3>
				<p align="justify"><b><?php echo $rowParada['adreca']; ?></b></p>
				
				<table style="width: 100%;" border="0" align="center">
					<tbody>
						<tr>
							<td style="background-color: #007755; text-align: center;"><font style="color:white">Líneas que tienen parada</font></td>
						</tr>
						<tr>
				...
				<div data-role="navbar">
	            	<ul>
						...
						<li><a href="./tempsbus.php?codi=?<?php echo $rowParada['nom']; ?>" class='ui-btn-active' data-icon="info">Próximo bus</a></li>

						<li><a href="../../mapa.php?lat=<?php echo $rowParada['lat']; ?>&long=<?php echo $rowParada['lon']; ?> " data-icon="location" data-ajax="false" />Ubicación</a></li>					
					</ul>
	       		 </div>
