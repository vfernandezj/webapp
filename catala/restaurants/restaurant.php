...
<body> 
	<div data-role="page">
		...
		<div data-role="content">				
				...
				<h2><font color="#007755"><?php echo $rowRestaurant['nom']; ?></font><br/><font size="2"><strong>Adreça</strong>:&nbsp;<?php echo $rowRestaurant['adreca']; ?></font></h2>
				
				<p align="center"><img width="100%" src="<?php echo $rowRestaurant['imageWebURL']; ?>" /></p>
				<p><font color="#007755"><b>Tipus:</b></font>&nbsp;<?php echo $rowRestaurant['tipus']; ?></p>
				<p align="justify"><?php echo $rowRestaurant['Descripcio']; ?></p>					
				...
				<div data-role="navbar">
	            	<ul>
						...
						<li><a href="../../mapa.php?lat=<?php echo $rowRestaurant['lat']; ?>&long=<?php echo $rowRestaurant['lon']; ?> " data-icon="location" data-ajax="false" />On</a></li>
					</ul>
	       		 </div>
				</div>
		</div> <!-- Fi content	-->
