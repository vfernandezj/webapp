	...
	<div data-role="page">
		...
		<div data-role="header">
			...
			<div data-role="content">
				...
				<p align="justify"><?php echo $rowPlatges['Descripcio']; ?></p>					
				...
				<div data-role="navbar">
	            	<ul>
						...
						<li><a href="../../mapa.php?lat=<?php echo $rowPlatges['lat']; ?>&long=<?php echo $rowPlatges['lon']; ?> " data-icon="location" data-ajax="false" />A on</a></li>					
					</ul>
	       		 </div>
