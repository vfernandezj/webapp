	...
	<div data-role="page">
		...
		<div data-role="header">
		   ...
		   <?php
				...
				$sentencia = "select guia.poi.id, guia.poi.nom from guia.poi where guia.poi.tipus='q'";
		   ...
		   ?>
				...
				<div class="choice_list"> 
					...
					<?php 
						...
						{	
							$web="http://guia.viladecans.cat/guia2/catala/llocsinteres/historics.php?idHistoric=" .$row['id'];
					?>
