...
<body> 
	<div data-role="page">
		...
		<div data-role="content">				
				...
				<p align="justify"><?php echo $rowCultura['Descripcio']; ?></p>					
				
				<div>	
					<p>Estem a <?php echo $rowCultura['adreca']; ?></p>
				...
				<div data-role="navbar">
	            	<ul>
						...
						<li><a href="../../mapa.php?lat=<?php echo $rowCultura['lat']; ?>&long=<?php echo $rowCultura['lon']; ?> " data-icon="location" data-ajax="false" />On</a></li>
					</ul>
	       		 </div>
