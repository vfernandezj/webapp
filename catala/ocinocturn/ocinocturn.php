...
<body> 
	<div data-role="page">
		...
		<div data-role="content">				
				...
				<p align="justify"><?php echo $rowNocturn['Descripcio']; ?></p>					
				
				<div>	
					<p>Estem a <?php echo $rowNocturn['adreca']; ?></p>
				...
				<div data-role="navbar">
	            	<ul>
						...
						<li><a href="../../mapa.php?lat=<?php echo $rowNocturn['lat']; ?>&long=<?php echo $rowNocturn['lon']; ?> " data-icon="location" data-ajax="false" />On</a></li>
					</ul>
	       		 </div>
				</div>
		</div> <!-- Fi content	-->
