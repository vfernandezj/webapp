...
<div data-role="page">
		...
		<div data-role="header">
		   ...
		   ?>
				...
				<h3 style="color:#007755" align="justify">Parades d'autob&uacute;s per a on passa la l&iacute;nia <?php echo $codiLinia?></h3>
				<hr/>
				</div>
				<div class="choice_list"> 
					...
					?>
							...
							<li><a href="<?php echo $web;?>"><h3 style="white-space:normal;">Parada:&nbsp;<?php echo $row['nom']; ?><br/><?php echo $direccion; ?></h3></a></li>	
